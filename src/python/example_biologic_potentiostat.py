...
print("CV technique")
Ei = CVStep(voltage=0, scan_rate=0.1, vs_initial=False)

E1 = CVStep(voltage=1, scan_rate=0.1, vs_initial=False)

E2 = CVStep(voltage=0, scan_rate=0.1, vs_initial=False)

Ef = CVStep(voltage=0, scan_rate=0.1, vs_initial=False)
